...
u8 key_state[] = {UP,UP,UP,UP,UP};//记录按键的状态

/* 判断按键状态的宏函数 */
#define KEY_IS_DOWN(x) key_state[x] == DOWN
#define KEY_IS_UP(x) key_state[x] == UP
/* 设置按键状态的宏函数 */
#define KEY_SET_DOWN(x) key_state[x] = DOWN
#define KEY_SET_UP(x) key_state[x] = UP
