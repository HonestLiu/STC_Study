...
//按键之前的状态是否为抬起
#define IS_KEY_UP(row_id, col_id) key_last_state[(4 * row_id) + col_id] == UP
//按键之前的状态是否为按下
#define IS_KEY_DOWN(row_id, col_id) key_last_state[(4 * row_id) + col_id] == DOWN
//修改按键当前状态为按下
#define SET_KEY_DOWN(row_id, col_id) key_last_state[(4 * row_id) + col_id] = DOWN
//修改按键当前状态为抬起
#define SET_KEY_UP(row_id, col_id) key_last_state[(4 * row_id) + col_id] = UP
